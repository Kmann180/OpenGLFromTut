...
namespace tbyte
{
	...
	Matrix4	operator * (const tbyte::Vector3 &a_Vector);
	void operator *= (const tbyte::Vector3 &a_Vector);
	Matrix4	operator * (const tbyte::Vector4 &a_Vector);
	void operator *= (const tbyte::Vector4 &a_Vector);
	...
	inline void Matrix4::operator *= (const tbyte::Vector3 &a_Vector)
	{

	}
	inline Matrix4	Matrix4::operator * (const tbyte::Vector4 &a_Vector)
	{

	}
	inline void Matrix4::operator *= (const tbyte::Vector4 &a_Vector)
	{
